...
def render_structured_analytics(inventory, tickets, merged):
    ...
    # ── SWITCHES ──────────────────────────────────────────────────────────────
        ...
        st.write(sw['device_error'].value_counts().head(1))
...
def main():
    ...
    # =========================================================================
        ...
        with tab1:
            ...
            c1.metric("Inventory Items", len(inventory))
            c2.metric("Total Tickets",   len(tickets))
            c3.metric("Product Types",   tickets['device_type'].nunique())
        ...
        with tab3:
            ...
            # Presentation Quick Select Panel
